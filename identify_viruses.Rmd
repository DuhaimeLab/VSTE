...
```{r}
write_csv(viruses[,c('contig','provirus','keep_score_all', 'keep_score_high_MCC', 'keep_score_high_precision', 'keep_score_high_recall')], paste(dataset_name, 'top_viral_scores.csv', sep="_"))
```
