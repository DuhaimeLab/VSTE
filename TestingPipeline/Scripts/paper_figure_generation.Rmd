...
```{r}
viruses_1 <- accuracy_scores %>% filter(testing_set_index==1)
...
viral_scores_1 <- accuracy_scores %>% filter(testing_set_index==1)

rownames(viral_scores_1) <- viral_scores_1$toolcombo

viral_scores_1 <- viral_scores_1 %>%
  select(c("MCC"))
