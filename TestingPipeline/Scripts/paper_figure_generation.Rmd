...
```{r}
tnv_add_comp <- data.frame(test_set_index=rep(NA, ))
```
...
for (i in grep("0", tnv)) {
  ...
  no_tnv_prop$prop_viral[j] <-
    abs(accuracy_scores_one_ts$prop_viral[i]-prop_tnv)/accuracy_scores_one_ts$prop_viral[i]*100
  
  prop_tnv <- accuracy_scores_one_ts$MCC[grep(tc_tnv,accuracy_scores_one_ts$toolcombo)][1]
  no_tnv_prop$MCC[j] <-
    abs(accuracy_scores_one_ts$MCC[i]-prop_tnv)/accuracy_scores_one_ts$MCC[i]*100
  
  prop_tnv <- accuracy_scores_one_ts$precision[grep(tc_tnv,accuracy_scores_one_ts$toolcombo)][1]*100
  no_tnv_prop$precision[j] <-
    abs(accuracy_scores_one_ts$precision[i]-prop_tnv)/accuracy_scores_one_ts$precision[i]
  
  prop_tnv <- accuracy_scores_one_ts$recall[grep(tc_tnv,accuracy_scores_one_ts$toolcombo)][1]
  no_tnv_prop$recall[j] <-
    abs(accuracy_scores_one_ts$recall[i]-prop_tnv)/accuracy_scores_one_ts$recall[i]*100
