...
vscore$confusion_matrix <- "true negative"
vscore$confusion_matrix[vscore$seqtype=="virus" & vscore$vscore<1] <- "false negative"
vscore$confusion_matrix[vscore$seqtype=="virus" & vscore$vscore>=1] <- "true positive"
vscore$confusion_matrix[vscore$seqtype!="virus" & vscore$vscore>=1] <- "false positive"
