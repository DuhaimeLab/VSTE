...
keep_score[viruses$checkv_host_genes>50 & viruses$provirus=="No"] <- keep_score[viruses$checkv_host_genes>50 & viruses$provirus=="No"] - 1
table(keep_score, viruses$seqtype)
...
table(keep_score, viruses$seqtype)
keep_score[((viruses$checkv_viral_genes*3) <= viruses$checkv_host_genes) & viruses$provirus=="No"] <- keep_score[((viruses$checkv_viral_genes*3) <= viruses$checkv_host_genes) & viruses$provirus=="No"] - 1 # consider accounting for provirus designation
table(keep_score, viruses$seqtype)
