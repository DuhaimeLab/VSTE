...
```{r}
 ggplot(viruses, aes(x=checkv_viral_genes, y=confusion_matrix,
                   fill=confusion_matrix,
                   color=confusion_matrix)) +
 ...
 ggplot(viruses, aes(x=percent_viral, y=confusion_matrix,
                   fill=confusion_matrix,
                   color=confusion_matrix)) +
  geom_boxplot(alpha=0.3) +
  theme_light() +
 ...
 ggplot(viruses, aes(x=hallmark, y=confusion_matrix,
                   fill=confusion_matrix,
                   color=confusion_matrix)) +
  geom_boxplot(alpha=0.3) +
  theme_light() +
