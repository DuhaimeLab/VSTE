...
# checkV
checkV_path <- "TestingSetToolOutputs/testing_sets_checkv_output.tsv"
# VIBRANT
vibrant_path <- "TestingSetToolOutputs/testing_sets_vibrant_output.tsv"
# DeepVirFinder
dvf_path <- "TestingSetToolOutputs/testing_sets_deepvirfinder_output.tsv"
# Virsorter
vs_path <- "TestingSetToolOutputs/testing_sets_virsorter_output.tsv"
# Virsorter2
vs2_path <- "TestingSetToolOutputs/testing_sets_virsorter2_output.tsv"
# Kaiju
kj_path <- "TestingSetToolOutputs/merged.nreuk.kaiju.names.out"
# KB cutoff
KB_CUTOFF <- 3000
