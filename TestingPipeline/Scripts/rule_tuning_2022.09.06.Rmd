...
#    keep_score[input_seqs$category==6] <- keep_score[input_seqs$category==6] + 0.5
  ...
  if (include_tuning_not_viral) {
    ...
    keep_score[input_seqs$checkv_completeness>=75 & input_seqs$checkV_length<=5000] <- keep_score[input_seqs$checkv_completeness>=75 & input_seqs$checkV_length<=5000] - 1 # helped with protist contamination
  }
...
```{r}
#viruses_high <- viruses[viruses$keep_score_high_precision>=1,] #uncomment this line if high precision example
#viruses_high <- viruses[viruses$keep_score_high_recall>=1,] #uncomment this line if want high recall example 
viruses_high <- viruses[viruses$keep_score_all>=1,] #uncomment this line if want to use all 6 tools
#viruses_high <- viruses[,] #comment this line if want only the "high precision contigs"
viruses_high_mod <- viruses_high %>% select(keep_score_vb, keep_score_dvf,keep_score_vs2, keep_score_vs, keep_score_tuning)
...
sm <- as.data.frame(
    rbind(
        ...
        virusHighCount(viruses_high_mod, "keep_score_tuning")
    )
)

sm$method <- c("vibrant", "deepvirfinder", "virsorter2", "virsorter", "tuning")
sm
```
...
#viruses_high <- viruses[viruses$keep_score_high_recall>=1,] #uncomment this line if want high recall example 
#viruses_high <- viruses[viruses$keep_score_all>=1,] #uncomment this line if want to use all 6 tools
viruses_high <- viruses[viruses$keep_score_high_MCC>=1,] #uncomment this line if want to use high MCC/AUC/F1 example
#viruses_high <- viruses[,] #comment this line if want only the "high precision contigs"
viruses_high_mod <- viruses_high %>% select(keep_score_vb,keep_score_vs2, keep_score_vs, keep_score_kj, keep_score_tuning)
viruses_high_mod <- apply(viruses_high_mod, c(1,2), function(x) {if (x >= 0.5) {x <- 1} else {x <- 0}})
viruses_high_mod <- as_tibble(viruses_high_mod)
...
sm <- as.data.frame(rbind(table(rowSums(viruses_high_mod[viruses_high_mod$keep_score_vb>0,])),
                          ...
                          c(0,table(rowSums(viruses_high_mod[viruses_high_mod$keep_score_vs2>0,]))),
                          table(rowSums(viruses_high_mod[viruses_high_mod$keep_score_vs>0,])),
                          table(rowSums(viruses_high_mod[viruses_high_mod$keep_score_tuning>0,]))
                          )
)

sm$method <- c("tuning", "deepvirfinder", "vibrant", "virsorter", "virsorter2")
sm
```
...
viruses$keep_score_vb_dvf_vs2_vs_tuning <- getting_viral_set_1(viruses, include_deepvirfinder = T,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = F,
                                              include_tuning = T,
...
viruses$keep_score_vb_dvf_vs2_vs_tuning_kj <- getting_viral_set_1(viruses, include_deepvirfinder = T,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = T,
                                              include_tuning = T,
...
# Considering how each method contributes to the final prediction
```{r}
viruses_high <- viruses[viruses$keep_score_vb_dvf_vs2_vs_tuning_kj>=1,] #uncomment this line if want to use all 6 tools
viruses_high_mod <- viruses_high %>% select(keep_score_vb,keep_score_vb_dvf, 
                                            keep_score_vb_dvf_vs2, keep_score_vb_dvf_vs2_vs, 
                                            keep_score_vb_dvf_vs2_vs_tuning, keep_score_vb_dvf_vs2_vs_tuning_kj)
#viruses_high_mod <- apply(viruses_high_mod, c(1,2), function(x) {if (x >= 1) {x <- 1} else {x <- 0}})
viruses_high_mod <- as_tibble(viruses_high_mod)
...
viruses$keep_score_vb_vs2 <- getting_viral_set_1(viruses, include_deepvirfinder = F,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = F,
                                              include_tuning = F,
...
viruses$keep_score_vb_vs2_vs <- getting_viral_set_1(viruses, include_deepvirfinder = F,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = F,
                                              include_tuning = F,
...
viruses$keep_score_vb_vs2_vs_tuning <- getting_viral_set_1(viruses, include_deepvirfinder = F,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = F,
                                              include_tuning = T,
...
viruses$keep_score_vb_vs2_vs_tuning_kj <- getting_viral_set_1(viruses, include_deepvirfinder = F,
                                              include_vibrant = T,
                                              include_virsorter2 = T,
                                              include_kaiju = T,
                                              include_tuning = T,
...
```{r}
viruses_high <- viruses[viruses$keep_score_high_MCC>=1,] #uncomment this line if want to use all 6 tools
viruses_high_mod <- viruses_high %>% select(keep_score_vb, 
                                            keep_score_vb_vs2, keep_score_vb_vs2_vs, 
                                            keep_score_vb_vs2_vs_tuning, keep_score_vb_vs2_vs_tuning_kj)
#viruses_high_mod <- apply(viruses_high_mod, c(1,2), function(x) {if (x >= 1) {x <- 1} else {x <- 0}})
viruses_high_mod <- as_tibble(viruses_high_mod)
