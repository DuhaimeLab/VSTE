...
getting_viral_set_1 <- function(input_seqs,
  ...
  if (include_deepvirfinder) {
    keep_score[input_seqs$score>=0.7 & input_seqs$contig_length<10000] <- keep_score[input_seqs$score>=0.7 & input_seqs$contig_length<10000] + 0.5
   keep_score[input_seqs$score>=0.9 & input_seqs$contig_length<10000] <- keep_score[input_seqs$score>=0.9 & input_seqs$contig_length<10000] + 1
  }
