...
```{r}
viruses <- full_join(x=vs2_c, y=dvf_c, by = "contig")
viruses <- full_join(x=viruses, y=checkV, by = "contig")
viruses <- full_join(x=viruses, y=vb_c, by = "contig")
viruses <- full_join(x=viruses, y=vs_c, by = "contig")
viruses <- full_join(x=viruses, y=kj_c, by = "contig")
```
...
ggplot(viruses, aes(x=checkv_length)) + geom_histogram(binwidth=10000)
```
