...
# DeepVirFinder
dvf_path <- "DrinkingWaterToolOutput/merged_lake_michigan_dvf_assemblies.tsv"
# Virsorter
vs_path <- "DrinkingWaterToolOutput/vs_merged_all.txt"
# Virsorter2
vs2_path <- "DrinkingWaterToolOutput/vs2_merged_file.txt"
# Kaiju
kj_path <- "DrinkingWaterToolOutput/merged_lake_michigan_kaiju_assemblies.tsv"
# KB cutoff
KB_CUTOFF <- 3000
...
```{r}
viruses$keep_score_vbvs2vscv <- getting_viral_set_1(viruses, include_vibrant = T,
...
```{r}
table(viruses$keep_score_vbvs2vscv>=1)
```
...
## vibrant virsorter2 virsorter checkV
```{r}
viruses$keep_score_vbvs2vscv_3 <- getting_viral_set_3(viruses, include_vibrant = T,
                                            include_virsorter2 = T,
                                            include_checkV = T,
                                            include_virsorter = T,
                                            include_deepvirfinder = F)
...
```{r}
table(viruses$keep_score_vbvs2vscv_3>=1)
```
...
## vibrant virsorter2 virsorter checkV
```{r}
viruses$keep_score_vbvs2vscv_2 <- getting_viral_set_2(viruses, include_vibrant = T,
                                            include_virsorter2 = T,
                                            include_checkV = T,
                                            include_virsorter = T,
                                            include_deepvirfinder = F)
...
```{r}
table(viruses$keep_score_vbvs2vscv_2>=1)
```
